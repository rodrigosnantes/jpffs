...
import { Shield, User, Save, TrendingUp, Award, Target, Zap, Trophy, UserX, Key, Lock } from 'lucide-react';
        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="col-span-1 space-y-6">
                    {/* ── Edit Card ────────────────────────────────────────── */}
                    <Card className="space-y-6 h-fit bg-gradient-to-br from-surface to-black/40 relative overflow-hidden">
                    ...
                    <Card className="space-y-6 h-fit bg-gradient-to-br from-surface to-black/40 relative overflow-hidden">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h3 className="text-xl font-bold text-white font-header">Mudar Senha</h3>
                        </div>
                        ...
                        <form onSubmit={handlePasswordChange} className="space-y-4">
                            {passwordMessage && (
                                <div className={cn(
                                    ...
                                    passwordMessage.type === 'error' ? "bg-red-500/10 text-red-400 border border-red-500/20" : "bg-green-500/10 text-green-400 border border-green-500/20"
                                )}>
